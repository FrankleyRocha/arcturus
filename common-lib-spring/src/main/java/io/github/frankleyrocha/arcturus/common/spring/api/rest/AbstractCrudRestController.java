...
import io.github.frankleyrocha.arcturus.common.persistence.repository.CrudRepository;
import io.github.frankleyrocha.arcturus.common.persistence.repository.query.QueryRequest;
import io.github.frankleyrocha.arcturus.common.persistence.repository.query.builder.QueryRequestBuilder;
...
public abstract class AbstractCrudRestController<T, ID /* , FILTER extends AbstractFilter */>
    ...
    public AbstractCrudRestController(CrudRepository<T, ID> service) {
